...
/**
 * Event when a failed fill queue task is retried successfully.
 *
...
/**
 * Fired after a fill retry completes and the queue row is updated.
 */
class fill_task_retried extends queue_task_base {
    /**
     * Init method.
     */
    ...
    public static function get_name(): string {
        return get_string('eventfilltaskretried', 'block_dixeo_modulegen');
    }
    ...
    public function get_description(): string {
        return get_string('eventfilltaskretrieddesc', 'block_dixeo_modulegen', (object) [
            'userid' => $this->userid,
    ...
    /**
     * Create an event for a successful fill retry.
     *
     * @param object $task Queue row.
     * @param int $userid User who retried the fill task.
