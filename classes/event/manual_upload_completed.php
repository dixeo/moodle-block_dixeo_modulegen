...
/**
 * Event when a manual upload is logged to the modulegen queue.
 *
...
/**
 * Fired after a manual upload queue row is created.
 */
class manual_upload_completed extends queue_task_base {
    /**
     * Init method.
     */
    ...
    public static function get_name(): string {
        return get_string('eventmanualuploadcompleted', 'block_dixeo_modulegen');
    }
    ...
    public function get_description(): string {
        return get_string('eventmanualuploadcompleteddesc', 'block_dixeo_modulegen', (object) [
            'userid' => $this->userid,
    ...
    /**
     * Create an event for a logged manual upload.
     *
