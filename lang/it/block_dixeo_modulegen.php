...
$string['privacy:metadata:external:courseid'] = 'L\'ID del corso associato alla richiesta di generazione o caricamento.';
$string['privacy:metadata:external:filename'] = 'Nomi di file caricati che possono essere inviati per l\'elaborazione o l\'indicizzazione.';
$string['privacy:metadata:external:instructions'] = 'Istruzioni di generazione o fill inserite dal docente.';
...
$string['privacy:metadata:queue:description'] = 'Descrizione opzionale memorizzata con la riga della coda.';
$string['privacy:metadata:queue:instructions'] = 'Istruzioni di generazione o fill in testo libero che possono includere dati personali.';
$string['privacy:metadata:queue:jobid'] = 'L\'identificatore di job Dixeo o locale della riga della coda.';
$string['privacy:metadata:queue:lang'] = 'Il codice lingua usato per la richiesta.';
$string['privacy:metadata:queue:modulename'] = 'Il tipo di modulo dell\'attività in coda.';
$string['privacy:metadata:queue:params'] = 'Metadati JSON (ID utente mittente se noto, nomi file, errori, flag di modalità).';
$string['privacy:metadata:queue:sectionnumber'] = 'La sezione del corso destinata all\'attività.';
$string['privacy:metadata:queue:status'] = 'Lo stato dell\'attività in coda.';
$string['privacy:metadata:queue:timecompleted'] = 'Quando l\'attività è stata completata, non riuscita o annullata.';
$string['privacy:metadata:queue:timecreated'] = 'Quando è stata creata la riga della coda.';
$string['privacy:metadata:queue:timestarted'] = 'Quando è iniziata l\'elaborazione dell\'attività.';
$string['privacy:metadata:queue:title'] = 'Titolo visualizzato della riga della coda (nome attività o etichetta di caricamento).';
$string['privacy:notice:avoidpersonaldata'] = 'I contenuti possono essere elaborati dai servizi Dixeo. Non includere dati personali non necessari sugli studenti nelle istruzioni o nei file caricati.';
$string['privacy:path:queue'] = 'Coda di generazione';
